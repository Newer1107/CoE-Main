...
>
> This document is the **pre-implementation specification** for Google Sign-In.
> Google Sign-In is **fully implemented and live** in this repository. This file
> is kept for historical reference only — do **not** follow it as a work order.
>
